"""Added IDDAW Classes and Palette

This goes under mmsegmentation/mmseg/utils
"""
...
def iddaw_classes():
    """IDDAW class names for external use."""
    return [
...
def iddaw_palette():
    """IDDAW palette for external use."""
    return [
        [0, 0, 3], [2, 1, 14], [6, 4, 27], [14, 8, 42], [22, 11, 57],
        [32, 12, 74], [43, 10, 86], [53, 9, 96], [65, 9, 103], [75, 12, 107],
        [87, 15, 109], [96, 19, 110], [106, 23, 110], [117, 27, 109],
        [126, 30, 108], [137, 34, 105], [147, 37, 103], [156, 41, 99],
        [167, 45, 95], [177, 49, 90], [187, 55, 84], [196, 60, 78],
        [204, 65, 72], [213, 73, 64], [220, 80, 57], [228, 90, 49],
        [233, 98, 42], [238, 108, 34], [243, 119, 25], [246, 129, 17],
        [249, 142, 8], [251, 153, 6], [251, 164, 10], [251, 177, 22],
        [250, 189, 35], [248, 203, 52], [245, 215, 69],
